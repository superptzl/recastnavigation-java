...
//    public static  float rcMax(float a, float b) { return a > b ? a : b; }
	...
	public static <T> void rcSwap(T[] a, T[] b)
	{
		T t = a[0];
		a[0] = b[0];
		b[0] = t;
	...
	public static <T extends Number> T rcClamp(T v, T mn, T mx)
	{
		return v.doubleValue() < mn.doubleValue() ? mn : (v.doubleValue() > mx.doubleValue() ? mx : v);
	}
