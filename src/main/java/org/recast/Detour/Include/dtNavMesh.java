...
//		~dtNavMesh();
		...
		public abstract dtStatus init(dtMeshHeader header, dtMeshTile tile, int flags);
	...
	public abstract dtNavMeshParams getParams();
		...
		/// @return The status flags for the operation.
		public abstract dtStatus addTile(unsigned char* data, int dataSize, int flags, dtTileRef lastRef, dtTileRef* result);
		...
		/// @return The status flags for the operation.
		public abstract dtStatus removeTile(dtTileRef ref, unsigned char** data, int* dataSize);
	...
	public abstract dtMeshTile getTileAt(int x, int y, int layer);
		...
		public abstract dtTileRef getTileRefAt(int x, int y, int layer);

		/// Gets the tile reference for the specified tile.
		///  @param[in]	tile	The tile.
		/// @return The tile reference of the tile.
		public abstract dtTileRef getTileRef(dtMeshTile tile);

		/// Gets the tile for the specified tile reference.
		///  @param[in]	ref		The tile reference of the tile to retrieve.
		/// @return The tile for the specified reference, or null if the
		///		reference is invalid.
	public abstract dtMeshTile getTileByRef(dtTileRef ref);
	...
	public abstract dtMeshTile getTile(int i);
		...
		/// @return The status flags for the operation.
		public abstract dtStatus getTileAndPolyByRef(dtPolyRef ref, dtMeshTile** tile, dtPoly** poly);

		/// Returns the tile and polygon for the specified polygon reference.
		///  @param[in]		ref		A known valid reference for a polygon.
		///  @param[out]	tile	The tile containing the polygon.
		///  @param[out]	poly	The polygon.
		public abstract void getTileAndPolyByRefUnsafe(dtPolyRef ref, dtMeshTile** tile, dtPoly** poly);

		/// Checks the validity of a polygon reference.
		///  @param[in]	ref		The polygon reference to check.
		/// @return True if polygon reference is valid for the navigation mesh.
		public abstract boolean isValidPolyRef(dtPolyRef ref);

		/// Gets the polygon reference for the tile's base polygon.
		///  @param[in]	tile		The tile.
		/// @return The polygon reference for the base polygon in the specified tile.
		public abstract dtPolyRef getPolyRefBase(dtMeshTile tile);
		...
		/// @return The status flags for the operation.
		public abstract dtStatus getOffMeshConnectionPolyEndPoints(dtPolyRef prevRef, dtPolyRef polyRef, float* startPos, float* endPos);

		/// Gets the specified off-mesh connection.
		///  @param[in]	ref		The polygon reference of the off-mesh connection.
		/// @return The specified off-mesh connection, or null if the polygon reference is not valid.
	public abstract dtOffMeshConnection getOffMeshConnectionByRef(dtPolyRef ref);
		...
		/// @return The status flags for the operation.
		public abstract dtStatus setPolyFlags(dtPolyRef ref, short flags);

		/// Gets the user defined flags for the specified polygon.
		///  @param[in]		ref				The polygon reference.
		///  @param[out]	resultFlags		The polygon flags.
		/// @return The status flags for the operation.
		public abstract dtStatus getPolyFlags(dtPolyRef ref, int[] resultFlags);

		/// Sets the user defined area for the specified polygon.
		///  @param[in]	ref		The polygon reference.
		///  @param[in]	area	The new area id for the polygon. [Limit: < #DT_MAX_AREAS]
		/// @return The status flags for the operation.
		public abstract dtStatus setPolyArea(dtPolyRef ref, char area);

		/// Gets the user defined area for the specified polygon.
		///  @param[in]		ref			The polygon reference.
		///  @param[out]	resultArea	The area id for the polygon.
		/// @return The status flags for the operation.
		public abstract dtStatus getPolyArea(dtPolyRef ref, char[] resultArea);
		...
		public dtPolyRef encodePolyId(int salt, int it, int ip)
		{
		...
		///  @see #encodePolyId
		public  void decodePolyId(dtPolyRef ref, int& salt, int& it, int& ip)
		{
			dtPolyRef saltMask = ((dtPolyRef)1<<m_saltBits)-1;
			dtPolyRef tileMask = ((dtPolyRef)1<<m_tileBits)-1;
		...
		///  @param[in]	ref		The polygon reference.
		///  @see #encodePolyId
	public   int decodePolyIdSalt(dtPolyRef ref)
		{
			dtPolyRef saltMask = ((dtPolyRef)1<<m_saltBits)-1;
		...
		///  @param[in]	ref		The polygon reference.
		///  @see #encodePolyId
	public   int decodePolyIdTile(dtPolyRef ref)
		{
			dtPolyRef tileMask = ((dtPolyRef)1<<m_tileBits)-1;
		...
		///  @param[in]	ref		The polygon reference.
		///  @see #encodePolyId
	public   int decodePolyIdPoly(dtPolyRef ref)
		{
			dtPolyRef polyMask = ((dtPolyRef)1<<m_polyBits)-1;
...
//	private:
		...
		public abstract dtPolyRef findNearestPolyInTile(dtMeshTile tile, float* center,
										float* extents, float* nearestPt);
		/// Returns closest point on polygon.
		public abstract void closestPointOnPolyInTile(dtMeshTile tile, unsigned int ip,
